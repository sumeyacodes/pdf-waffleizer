...
export function ViewPDF() {
  ...
  // will remove this to another component at some point
  const DefaultMD = `## Sample PDF
...
_In mauris. Pellentesque dui nisi, iaculis eu, rhoncus in, venenatis ac, ante. Ut odio justo,
...
enim commodo interdum. Donec odio. Sed sollicitudin dui vitae justo._
